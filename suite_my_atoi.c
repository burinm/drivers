...
char test_atoi_max(){
    SETUP;
    int32_t result= my_atoi("2147483647");
    printf("result is: %d\n",result);
...
char test_atoi_min(){
    SETUP;
    int32_t result= my_atoi("-2147483648");
    printf("result is: %d\n",result);
...
char test_atoi_max_plus_two(){
    SETUP;
    int32_t result= my_atoi("2147483649");
    printf("result is: %d\n",result);
    ASSERT(mylib_errno == MYLIB_ERR_MAX_RANGE);
}
...
char test_atoi_min_minus_two(){
    SETUP;
    int32_t result= my_atoi("-2147483650");
    printf("result is: %d\n",result);
    ASSERT(mylib_errno == MYLIB_ERR_MIN_RANGE);
}
...
char test_atoi_garbage(){
    SETUP;
    int32_t result= my_atoi("blahblahblah");
    printf("result is: %d\n",result);
